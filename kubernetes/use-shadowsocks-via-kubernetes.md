...
### 3.10 Protect your server

Refer to [Use fail2ban and Honeypot to secure your app server](../security/use-fail2ban-and-honeypot-to-secure-app-server.md) to protect your server.
